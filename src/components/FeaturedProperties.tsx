...
export function FeaturedProperties() {
  ...
  if (items.length === 0) {
    return (
      <section className="bg-black pt-24 pb-12 md:pt-32 md:pb-16 flex items-center justify-center min-h-[400px]">
        <div className="flex flex-col items-center gap-4">
          ...
          <span className="text-white/70 text-lg">Cargando propiedades destacadas...</span>
        </div>
      </section>
    );
  }
